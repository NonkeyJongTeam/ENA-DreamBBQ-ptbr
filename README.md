...
* #### Linux
É do nosso conhecimento a (possivelmente temporária) falta de build nativa para Linux, todavia é completamente possivel rodar o mod do jogo usando o Proton da Steam e colocando o comando **WINEDLLOVERRIDES="winhttp=n,b" %command%** nas **OPÇÕES DE INICIALIZAÇÃO** clicando com o botão direito no jogo e indo em: **Propriedades** > **Geral**. Estamos buscando informações de feedbacks acerca do funcionamento do mod em outras distros Linux, caso você queira colaborar e/ou saiba de informações sobre o assunto ficaremos gratos em conversar.<br>
* #### Mac 
...
<b>Bixin</b> ▸ Ajuda em 3D<br>
 ###### <small>Um agradecimento a todos que nos apoiaram e mandaram mensagens positivas para todo o nosso time! (Agradecimento especial para toast_buns) Desejamos um bom trabalho a todos os recém-empregados deste ano e um feliz ƎNA DAY 2026!!!</small>
