...
* #### Dublagem
Gostou da dublagem? Foi inteiramente feita, dirigida e mixada pela Equipe de fã dublagem [**Ghost Clematis**](https://www.youtube.com/@voiddublagens) e [**Void Dublagens**](https://www.youtube.com/@voiddublagens). Nós só a colocamos no jogo, então todos os créditos e direitos são deles pela versões dubladas. <br>
* #### Linux (Mint)
